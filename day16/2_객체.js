...
// [2] 객체 정보 확인 / 정보 분석
console.log(영화정보);
console.log(영화정보.boxOfficeResult); // 자료 결과 정보 : boxofficeType, showRange, weeklyBoxOfficeList, yearWeekTime
console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList); // 주간 박스오피스의 영화 정보 목록
console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList[1].rank); // 주간 박스오피스의 2번째 영화 정보의 순위
console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList[1].movieNm); // 주간 박스오피스의 2번째 영화 정보의 영화명
...
for(let index = 0; index <= 영화정보.boxOfficeResult.weeklyBoxOfficeList.length -1; index++){
    // index는 0부터 주간박스오피스의 마지막인덱스까지 1씩 증가 반복
    // index번째의 영화 호출
